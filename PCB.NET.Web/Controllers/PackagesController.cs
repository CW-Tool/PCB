...
namespace PCB.NET.Web.Controllers
{
    public class PackagesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PackagesId,Packs")] Package package)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PackagesId,Packs")] Package package)
        {
            if (ModelState.IsValid)
            {
